...
export const GetAllContestsDocument = gql`
...
/**
 * __useGetAllContestsQuery__
 *
 * To run a query within a React component, call `useGetAllContestsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllContestsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllContestsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetAllContestsQuery(baseOptions?: Apollo.QueryHookOptions<GetAllContestsQuery, GetAllContestsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllContestsQuery, GetAllContestsQueryVariables>(GetAllContestsDocument, options);
      }
export function useGetAllContestsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllContestsQuery, GetAllContestsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAllContestsQuery, GetAllContestsQueryVariables>(GetAllContestsDocument, options);
        }
export function useGetAllContestsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetAllContestsQuery, GetAllContestsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetAllContestsQuery, GetAllContestsQueryVariables>(GetAllContestsDocument, options);
        }
export type GetAllContestsQueryHookResult = ReturnType<typeof useGetAllContestsQuery>;
export type GetAllContestsLazyQueryHookResult = ReturnType<typeof useGetAllContestsLazyQuery>;
export type GetAllContestsSuspenseQueryHookResult = ReturnType<typeof useGetAllContestsSuspenseQuery>;
export type GetAllContestsQueryResult = Apollo.QueryResult<GetAllContestsQuery, GetAllContestsQueryVariables>;
